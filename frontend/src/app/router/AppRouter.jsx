...
import ProfileSelector from '@/packages/p1-seguridad-administracion/auth/pages/ProfileSelector'
import Login from '@/packages/p1-seguridad-administracion/auth/pages/Login'
import ForgotPassword from '@/packages/p1-seguridad-administracion/auth/pages/ForgotPassword'
import ResetPassword from '@/packages/p1-seguridad-administracion/auth/pages/ResetPassword'
import PreinscripcionForm from '@/packages/p2-participantes-grupos/preinscripcion/pages/PreinscripcionForm'
import Comprobante from '@/packages/p2-participantes-grupos/preinscripcion/pages/Comprobante'
import Dashboard from '@/packages/p4-reportes-monitoreo-auditoria/dashboard/pages/Dashboard'
