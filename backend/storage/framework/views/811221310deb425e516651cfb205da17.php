...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="greeting">Hola, <?php echo e($nombreCompleto); ?></div>
            ...
            <div class="credentials-box">
                <div class="credential-item">
                    ...
                    <span style="font-weight: bold; color: #1a3a6b;"><?php echo e($perfil); ?></span>
                </div>
                <div class="credential-item">
                    <span class="credential-label">Usuario / Registro:</span> 
                    <span class="credential-value"><?php echo e($codigoUsuario); ?></span>
                </div>
                <div class="credential-item">
                    <span class="credential-label">Contraseña inicial:</span> 
                    <span class="credential-value"><?php echo e($ci); ?></span>
                </div>
            </div>
            ...
            <div style="text-align: center;">
                <a href="<?php echo e($urlLogin); ?>" class="btn-login" target="_blank">Ingresar al Sistema</a>
            </div>

            <p class="warning-text">⚠️ Si no puedes hacer clic en el botón superior, copia y pega la siguiente URL en tu navegador:<br>
            <a href="<?php echo e($urlLogin); ?>"><?php echo e($urlLogin); ?></a></p>
        </div>
        <div class="footer">
...
<?php /**PATH /var/www/html/resources/views/emails/cuenta-usuario.blade.php ENDPATH**/ ?>